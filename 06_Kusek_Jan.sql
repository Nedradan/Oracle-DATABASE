...
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI SEZONY
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into SEZON (SEZ_ROK_ROZPOCZECIA,SEZ_ROK_ZAKONCZENIA,SEZ_RODZAJ)
...
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI KATEGORIE
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
---------------------------------------------------------
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI ADRESY
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into ADRESY (ADR_MIEJSCOWOSC,ADR_KOD_POCZTOWY, ADR_ULICA, ADR_NR_DOMU)
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI OSOBY
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into OSOBY (OSO_IMIE1,OSO_NAZWISKO,OSO_PESEL,ADR_ID)
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI ZWIĄZKI
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into ZWIAZKI (ZWI_NAZWA,ADR_ID)
values ('MAZOWIECKI',3);
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI SZACHOWE LICENCJE
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into SZACHOWE_LICENCJE (SZA_DATA_UZYSKANIA, OSO_ID,KAT_ID,ZWI_ID)
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI DRUŻYNY
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into DRUZYNY (DRU_NAZWA, OSO_ID1,OSO_ID2,OSO_ID3,OSO_ID4,SEZ_ID)
...
---------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
-- INSTRUKCJE INSERT DLA TABELI ROZEGRANE MECZE
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
insert into ROZEGRANE_MECZE (TUR_ID,OSO_ID1,OSO_ID2,OSO_ID3,ROZ_WYNIK,ROZ_CZAS_TRWANIA_MIN,SEZ_ID)
...
--SZUKAM  IMIE I NAZWISKA OSÓB O ID ADRESU = 3
column OSO_IMIE1 HEADING 'IMIE' format A15
column OSO_NAZWISKO HEADING 'NAZWISKO' format A15

SELECT OSO_IMIE1,OSO_NAZWISKO 
FROM OSOBY 
WHERE ADR_ID = 3;
...
--SZUKAM ID SEZONU ORAZ DATE ROZPOCZECIA SEZONÓW MISTRZOWSKICH

column SEZ_ID HEADING 'ID' format 999999

column SEZ_ROK_ROZPOCZECIA HEADING 'DATA ROZPOCZECIA' format A21
SELECT SEZ_ID,SEZ_ROK_ROZPOCZECIA 
FROM SEZON 
WHERE SEZ_RODZAJ LIKE 'MISTRZOWSKI';
/*
     ID DATA ROZPOCZECIA
------- ---------------------
      1 2018-05-03 00:00
...
--SZUKAM ID KATEGORII I RANGE KATEGORII GDZIE TYP KATEGORII TO SEDZIA
column KAT_ID HEADING 'ID' format 999999

column KAT_RANGA HEADING 'POZIOM' format A20
SELECT KAT_ID,KAT_RANGA 
FROM KATEGORIE 
WHERE KAT_TYP LIKE 'SEDZIA';
/*
    ID POZIOM
------- --------------------
      2 POZIOM A+
...
--SZUKAM ID MECZU W KTORYM CZAS TRWANIA BYŁ WIEKSZY NIZ 5 MIN I MNIEJSZY NIZ 10 MIN
column ROZ_ID HEADING 'ID' format 999999

SELECT ROZ_ID 
FROM ROZEGRANE_MECZE 
WHERE ROZ_CZAS_TRWANIA_MIN > 5 AND ROZ_CZAS_TRWANIA_MIN < 10;
/*
      ID
-------
      4
...
--SZUKAM ID,IMIE,NAZWISKO,ADRES ID OSÓB O IMIENIU TOMASZ
column OSO_ID HEADING 'ID OSOBY' format 9999
column OSO_IMIE1 HEADING 'IMIE' format A15
column OSO_NAZWISKO HEADING 'NAZWISKO' format A15
column ADR_ID HEADING 'ID ADRESUU' format 9999

SELECT OSO_ID,OSO_IMIE1,OSO_NAZWISKO,ADR_ID 
FROM OSOBY 
WHERE OSO_IMIE1 LIKE 'TOMASZ';
/*
      ID
-------
      4
...
--SZUKAM ID,DATE UZYSKANIA,ID POSIADACZA,KATEGORIE LICENCJI SZACHOWYCH, KTORE ZOSTALY WYDANE PRZED '2016/01/01'
column SZA_ID HEADING 'ID' format 9999
column SZA_DATA_UZYSKANIA HEADING 'DATA UZYSKANIA' format A20
column OSO_ID HEADING 'ID OSOBY' format 9999
column KAT_ID HEADING 'ID KATEGORII' format 9999

SELECT SZA_ID,OSO_ID,SZA_DATA_UZYSKANIA,KAT_ID 
FROM SZACHOWE_LICENCJE 
WHERE SZA_DATA_UZYSKANIA < '2016/01/01';
